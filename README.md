...
This repository holds the base docker image used to build [Gleam](https://gleam.run/) development containers for Visual Studio Code.

Currently it ships with Gleam, Elixir, and Erlang. Erlang is a requirement for Gleam and I have decided to also add Elixir for some interop ;)

## Building the Gleam image
